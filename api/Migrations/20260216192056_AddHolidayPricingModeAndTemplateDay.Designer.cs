...
namespace QuestRoomApi.Migrations
{
    ...
    [Migration("20260216192056_AddHolidayPricingModeAndTemplateDay")]
    partial class AddHolidayPricingModeAndTemplateDay
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("QuestRoomApi.Models.ApiRequestLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("QuestRoomApi.Models.BlacklistEntry", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("QuestRoomApi.Models.Booking", b =>
                {
                    ...
                    b.Property<string>("AggregatorUniqueId")
                        .HasColumnType("text")
                        .HasColumnName("aggregator_unique_id");
                    ...
                    b.Property<int?>("QuestPrice")
                        .HasColumnType("integer")
                        .HasColumnName("quest_price");
            ...
            modelBuilder.Entity("QuestRoomApi.Models.Quest", b =>
                {
                    ...
                    b.Property<Guid?>("ParentQuestId")
                        .HasColumnType("uuid")
                        .HasColumnName("parent_quest_id");
                    ...
                    b.Property<int>("StandardPriceParticipantsMax")
                        .HasColumnType("integer")
                        .HasColumnName("standard_price_participants_max");
            ...
            modelBuilder.Entity("QuestRoomApi.Models.Settings", b =>
                {
                    ...
                    b.Property<bool>("BlockBlacklistedApiBookings")
                        .HasColumnType("boolean")
                        .HasColumnName("block_blacklisted_api_bookings");

                    b.Property<bool>("BlockBlacklistedSiteBookings")
                        .HasColumnType("boolean")
                        .HasColumnName("block_blacklisted_site_bookings");
                    ...
                    b.Property<bool>("MirKvestovApiLoggingEnabled")
                        .HasColumnType("boolean")
                        .HasColumnName("mir_kvestov_api_logging_enabled");

                    b.Property<string>("MirKvestovMd5Key")
                        .HasColumnType("text")
                        .HasColumnName("mir_kvestov_md5_key");

                    b.Property<string>("MirKvestovPrepayMd5Key")
                        .HasColumnType("text")
                        .HasColumnName("mir_kvestov_prepay_md5_key");

                    b.Property<int>("MirKvestovScheduleDaysAhead")
                        .HasColumnType("integer")
                        .HasColumnName("mir_kvestov_schedule_days_ahead");

                    b.Property<string>("MirKvestovScheduleFields")
                        .HasColumnType("text")
                        .HasColumnName("mir_kvestov_schedule_fields");

                    b.Property<string>("MirKvestovSlotIdFormat")
                        .HasColumnType("text")
                        .HasColumnName("mir_kvestov_slot_id_format");
            ...
            modelBuilder.Entity("QuestRoomApi.Models.StandardExtraService", b =>
                {
                    ...
                    b.Property<bool>("MandatoryForChildQuests")
                        .HasColumnType("boolean")
                        .HasColumnName("mandatory_for_child_quests");
            ...
            modelBuilder.Entity("QuestRoomApi.Models.Quest", b =>
                {
                    b.HasOne("QuestRoomApi.Models.Quest", "ParentQuest")
