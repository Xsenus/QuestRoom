...
export default function QuestCard({ quest }: QuestCardProps) {
  ...
  return (
    <div className="relative mb-4 md:mb-6 pt-3 md:pt-5">
      <div className="relative bg-white shadow-2xl overflow-hidden border-4 border-white w-full">
        <div className="grid grid-cols-[1.35fr_1fr] md:grid-cols-1">
          <div className="relative grid grid-cols-2 gap-0">
            ...
            <div className="relative grid grid-cols-2 gap-0">
              ...
              {quest.isNew && (
                <div className="absolute top-3 right-0 z-20 w-24 h-24 md:w-40 md:h-40 overflow-hidden pointer-events-none">
                  <div className="absolute top-6 -right-10 md:top-10 md:-right-16 w-40 md:w-60 bg-[#c51f2e] text-white text-center py-1 md:py-2 transform rotate-45 shadow-2xl">
                    <span className="text-[10px] md:text-base font-bold tracking-wider font-display">NEW</span>
                  </div>
                </div>
              )}
            </div>
          ...
          <div className="bg-white/95 text-gray-900 p-3 md:p-4 border-l border-white/90 md:border-l-0 md:border-t">
