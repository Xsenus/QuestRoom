    ...
    <div className="relative mb-4 md:mb-6 pt-3 md:pt-5">
      <div className="relative bg-white shadow-2xl overflow-visible border-4 border-white">
        <div className="relative">
          ...
          {quest.isNew && (
            <div className="absolute -top-3 -right-3 md:-top-6 md:-right-6 z-20 w-40 h-40 md:w-72 md:h-72 overflow-hidden pointer-events-none">
              <div className="absolute top-1/2 left-1/2 w-[180px] md:w-[360px] -translate-x-1/2 -translate-y-1/2 -rotate-45 bg-[#c51f2e] text-white text-center py-1.5 md:py-3 shadow-2xl">
                <span className="text-xs md:text-xl font-bold tracking-widest font-display">NEW</span>
              </div>
            </div>
          )}
        </div>
        ...
        <div className="bg-white/95 text-gray-900 p-3 md:p-4 border-t border-white/90">
          <div className="grid grid-cols-1 md:grid-cols-[1.3fr_1.1fr_2fr] gap-3 md:gap-6">
            <div className="grid grid-cols-2 gap-3 border-b border-gray-200 pb-3 md:border-b-0 md:pb-0 md:border-r md:pr-4">
              ...
              <div className="flex items-start gap-2">
                ...
                <div className="text-[11px] md:text-xs">
                  ...
                  <div className="text-gray-700">Уровень {difficultyValue}</div>
                </div>
              </div>
            </div>
            ...
            <p className="text-[11px] md:text-sm text-gray-700 leading-relaxed max-h-28 md:max-h-40 overflow-hidden md:pl-2">
              {quest.description}
            </p>
          </div>
        </div>
